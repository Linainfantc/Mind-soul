        ...
        <div class="container">
           <div class="row">
            ...
            <h2 style="font-size:18px">Envianos tu mensaje y pronto te responderemos</h2>
                <div class="row">
                    <div style="padding-top:10px;" class="col-sm-3"><label>Tú nombre :</label></div>
                    <div class="col-sm-8"><input type="text" placeholder="" name="name" class="form-control input-sm"  ></div>
                </div>
                <div style="margin-top:10px;" class="row">
                    <div style="padding-top:10px;" class="col-sm-3"><label>Tú Email:</label></div>
                    <div class="col-sm-8"><input type="text" name="name" placeholder="" class="form-control input-sm"  ></div>
                </div>
                 <div style="margin-top:10px;" class="row">
                    <div style="padding-top:10px;" class="col-sm-3"><label>Número de telefono:</label></div>
                    <div class="col-sm-8"><input type="text" name="name" placeholder="" class="form-control input-sm"  ></div>
                </div>
                 <div style="margin-top:10px;" class="row">
                    <div style="padding-top:10px;" class="col-sm-3"><label>Tú mensaje:</label></div>
                    <div class="col-sm-8">
